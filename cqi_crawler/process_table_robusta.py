...
for i in range(29):
    df1 = pd.read_csv('C:/Users/Acer/Desktop/Python/crawler_pratice/cqi/coffeedata/robusta/coffee_data_robusta_{}_table_0.csv'.format(i) ,header=None)
    df2 = pd.read_csv('C:/Users/Acer/Desktop/Python/crawler_pratice/cqi/coffeedata/robusta/coffee_data_robusta_{}_table_1.csv'.format(i))
    df3 = pd.read_csv('C:/Users/Acer/Desktop/Python/crawler_pratice/cqi/coffeedata/robusta/coffee_data_robusta_{}_table_2.csv'.format(i))
    df4 = pd.read_csv('C:/Users/Acer/Desktop/Python/crawler_pratice/cqi/coffeedata/robusta/coffee_data_robusta_{}_table_3.csv'.format(i))
    df5 = pd.read_csv('C:/Users/Acer/Desktop/Python/crawler_pratice/cqi/coffeedata/robusta/coffee_data_robusta_{}_table_4.csv'.format(i))
    ...
    #合併資料表
    df=pd.concat([df1_processed,df2_processed,df3_processed,df4_processed,df5_processed],axis=1)
    df.drop(['Status','Defects'],axis=1,inplace=True)
    df.rename(columns={'Fragrance / Aroma':'Aroma', 'Salt / Acid':'Acidity','Bitter / Sweet':'Sweetness','Mouthfeel':'Body',\
        'Uniform Cup':'Uniformity','Country of Origin':'Country.of.Origin','Farm Name':'Farm.Name','Lot Number':'Lot.Number',\
    ...
    df=df.reindex(columns=['Species', 'Owner', 'Country.of.Origin', 'Farm.Name', 'Lot.Number',
...
df_final.to_csv('C:/Users/Acer/Desktop/Python/crawler_pratice/cqi/coffeedata/robusta.csv',index = False)
